...
// Future<List<PostsModel> // list is pass because api url it is array, model passed because all the value

// inside array or object is define inside model
// if array name is given then it is easy to fetch, by using array name we can get array length.
